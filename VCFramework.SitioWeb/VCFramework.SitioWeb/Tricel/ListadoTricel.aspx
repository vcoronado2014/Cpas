<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ListadoTricel.aspx.cs" Inherits="VCFramework.SitioWeb.Tricel.ListadoTricel" %>
...
@media only screen and (max-width: 500px) {
    ...
    <script type="text/javascript">
        ...
        <span class="tituloContacto"><i class="foundicon-tools padding-right-15"></i>Tricel</span>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="large-12 columns">
            ...
            <dx:ASPxGridView ID="grillaDocumentos" runat="server" AutoGenerateColumns="False" DataSourceID="ODSLISTADO" Width="100%" ClientInstanceName="grid" OnHtmlDataCellPrepared="grillaDocumentos_HtmlDataCellPrepared" Theme="Mulberry1">
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="FechaInicio" VisibleIndex="4" ShowInCustomizationForm="True" Width="15%" Caption="Fecha Inicio">
                        <Settings AllowAutoFilter="False" AllowFilterBySearchPanel="True" AllowHeaderFilter="False" AutoFilterCondition="Contains" />
                        <CellStyle Wrap="True">
                        </CellStyle>
                    </dx:GridViewDataTextColumn>

                    <dx:GridViewDataTextColumn Caption=" " Name="control" VisibleIndex="0" Width="7%">
                        <DataItemTemplate>
                                <asp:HyperLink ID="hlInicio" runat="server" CssClass="item" NavigateUrl='<%# Eval("Id", "CrearTricel.aspx?editar=true&eliminar=false&nuevo=false&id={0}")%>'>
                                        <span data-tooltip aria-haspopup="true" class="has-tip" title="Editar">
                                        <i class="foundicon-edit" ></i></span>
                                </asp:HyperLink>
                                <asp:HyperLink ID="HyperLink1" runat="server" CssClass="item" NavigateUrl='<%# Eval("Id", "CrearTricel.aspx?eliminar=true&editar=false&nuevo=false&id={0}")%>' data-tooltip aria-haspopup="true" class="has-tip" title="Eliminar">
                    ...
                    <dx:GridViewDataTextColumn Caption="Fecha Creación" FieldName="FechaCreacion" VisibleIndex="2" Width="15%">
                        <Settings AllowAutoFilter="False" AllowHeaderFilter="False" ShowInFilterControl="False" />
                        <CellStyle Wrap="True">
                        </CellStyle>
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="Nombre" FieldName="Nombre" VisibleIndex="3" Width="35%">
                    </dx:GridViewDataTextColumn>


                    <dx:GridViewDataTextColumn Caption="Fecha Ter." FieldName="FechaTermino" VisibleIndex="5" Width="15%">
                        <Settings AllowAutoFilter="False" AllowHeaderFilter="False" />
                    </dx:GridViewDataTextColumn>

                    <dx:GridViewDataTextColumn Caption="Listas" FieldName="CantidadListas" VisibleIndex="6" Width="7%">
                    ...
                    <dx:GridViewDataTextColumn Caption="" Name="control1" VisibleIndex="7" Width="10%" Visible="False">
                        <DataItemTemplate>
                            <asp:HyperLink ID="HyperLink2" runat="server" Visible='<%# Eval("MostrarIconoCrear") %>' CssClass="item" NavigateUrl='<%# Eval("Id", "CrearLista.aspx?eliminar=false&editar=false&nuevo=true&id={0}")%>' data-tooltip aria-haspopup="true" class="has-tip" title="Crear/Modificar Lista">
                                        <i class="foundicon-edit"></i>
                            </asp:HyperLink>
                            <asp:HyperLink ID="HyperLink3" runat="server" Visible='<%# Eval("MostrarIconoEliminar") %>'  CssClass="item" NavigateUrl='<%# Eval("Id", "CrearLista.aspx?eliminar=true&editar=false&nuevo=false&id={0}")%>' data-tooltip aria-haspopup="true" class="has-tip" title="Eliminar Lista">
                                        <i class="foundicon-trash"></i>
                            </asp:HyperLink>
                        </DataItemTemplate>
                    </dx:GridViewDataTextColumn>
            ...
            <asp:ObjectDataSource ID="ODSLISTADO" runat="server" SelectMethod="ObtenerTricelPorInstIdTodosFucnional" TypeName="VCFramework.NegocioMySQL.Tricel">
                <SelectParameters>
                    <asp:SessionParameter DefaultValue="0" Name="instId" SessionField="INST_ID" Type="Int32" />
                    <asp:SessionParameter DefaultValue="0" Name="usuIdLogueado" SessionField="USU_ID" Type="Int32" />
                </SelectParameters>
