<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="VotarLista.aspx.cs" Inherits="VCFramework.SitioWeb.Tricel.VotarLista" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	//var valores = lblIngresosEgresos.GetText();
                ...
                <PanelCollection>
                    <dx:PanelContent runat="server">
                        ...
                        <div class="row">
                            <fieldset>
                                <legend>Listas de este Tricel
                                </legend>
                                <div class="large-12 columns panel callout">
                                    <!-- aca el texto de las listas-->
                                    <asp:Literal ID="literalListaVotos" runat="server"></asp:Literal>
                                </div>
                            ...
                            <fieldset>
                                ...
                                <div class="row" style="margin-top:5px; padding-top:5px;">
                                    ...
                                    <div class="medium-6 columns">
                                        ...
                                        <dx:ASPxButton ID="btnVolver" runat="server" CausesValidation="False" ClientInstanceName="btnLimpiar" CssClass="button warning" Native="True" OnClick="btnVolver_Click" style="-webkit-appearance: none;-moz-appearance: none;border-radius: 0;border-style: solid;border-width: 0;cursor: pointer;font-family: Helvetica, Roboto, Arial, sans-serif;font-weight: normal;line-height: normal;margin: 0 0 1.25rem;position: relative;text-align: center;text-decoration: none;display: inline-block;padding: 1rem 2rem 1.0625rem 2rem;font-size: 1rem;color: #FFFFFF;transition: background-color 300ms ease-out;" Text="Volver">
                                        </dx:ASPxButton>
    ...
    //ActualizaGrafico(valor);
                        ...
                        <div class="row">
                            ...
                            <dx:ASPxLabel ID="litMensaje" runat="server">
                            </dx:ASPxLabel>
