<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Usuarios.aspx.cs" Inherits="VCFramework.SitioWeb.Administracion.Usuarios" %>
...
@media only screen and (max-width: 500px) {
    ...
    <div class="row panel bg-titulo" style="margin:0.1em;">
        <span class="tituloContacto"><i class="foundicon-people padding-right-15"></i>  Administración de Usuarios</span>
    </div>
    <div class="row">
        ...
        <div class="medium-12 columns">
                ...
                <dx:ASPxGridView ID="grillaUsuarios" runat="server" AutoGenerateColumns="False" DataSourceID="ODSLISTADO" Width="100%" ClientInstanceName="grid" Theme="Mulberry1">
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn FieldName="NombreUsuario" VisibleIndex="2" ShowInCustomizationForm="True">
                            <Settings AllowAutoFilter="True" AllowFilterBySearchPanel="True" AllowHeaderFilter="True" AutoFilterCondition="Contains" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="NombreCompleto" VisibleIndex="3" ShowInCustomizationForm="True">
                            <Settings AllowAutoFilter="True" AllowFilterBySearchPanel="True" AllowHeaderFilter="True" AutoFilterCondition="Contains" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="Rol" VisibleIndex="4" ShowInCustomizationForm="True">
                            <Settings AllowAutoFilter="True" AllowFilterBySearchPanel="True" AllowHeaderFilter="True" AutoFilterCondition="Contains" />
                        </dx:GridViewDataTextColumn>
                ...
                <asp:ObjectDataSource ID="ODSLISTADO" runat="server" SelectMethod="ListarUsuariosEnvoltorio" TypeName="VCFramework.SitioWeb.LogicLogin">
                    <SelectParameters>
