...
namespace VCFramework.SitioWeb.Administracion
{
    public partial class documentosUsuario : System.Web.UI.Page
    {
        ...
        {
            VCFramework.Entidad.DocumentosUsuario documento = new Entidad.DocumentosUsuario();
        ...
        private void ModificarArchivo(int id)
        {
            if (id > 0)
            {
                Entidad.DocumentosUsuario doc = NegocioMySQL.DocumentosUsuario.ObtenerDocumentoId(id);
