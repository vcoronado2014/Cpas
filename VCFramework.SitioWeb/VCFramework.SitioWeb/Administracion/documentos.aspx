<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="documentos.aspx.cs" Inherits="VCFramework.SitioWeb.Administracion.documentos" %>
...
@media only screen and (max-width: 500px) {
    ...
    <div class="row panel bg-titulo" style="margin:0.1em;">
        <span class="tituloContacto"><i class="foundicon-page padding-right-15"></i>Administración de Asambleas</span>
    </div>
    <div class="row">
        <div class="medium-12 columns">
            ...
            <div class="panel">
                <div class="row">
                    <div class="medium-12 columns">
                        <p>Esta página le permitirá subir los archivos al Repositorio de Asambleas de su Establecimiento.</p>
                    </div>
    ...
    <div class="row">
        <div class="medium-12 columns">
            ...
            <asp:ObjectDataSource ID="ODSLISTADO" runat="server" SelectMethod="ObtenerDocumentosPorInstId" TypeName="VCFramework.NegocioMySQL.Documentos">
                <SelectParameters>
