<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="vistaDocumentosUsuario.aspx.cs" Inherits="VCFramework.SitioWeb.Usuario.vistaDocumentosUsuario" %>
<%@ Register src="../controles/controlVistaDocumentosUsuario.ascx" tagname="controlVistaDocumentosUsuario" tagprefix="uc1" %>
...
@media only screen and (max-width: 500px) {
    ...
    $(document).ready(function () {
        $('.link1_2').magnificPopup({ type: 'iframe' });
    });
</script>
    <div class="row panel bg-titulo" style="margin:0.1em;">
        <span class="tituloContacto"><i class="foundicon-page padding-right-15"></i>Documentos del Establecimiento</span>
    </div>
    <div class="row">
        <div class="medium-12 columns">
            ...
            <div class="panel">
                <div class="row">
                    <div class="medium-12 columns">
                        <p>Esta página le permitirá ver los archivos de su Establecimiento.</p>
                    </div>
                </div>
            </div>
    ...
    <uc1:controlVistaDocumentosUsuario ID="controlVistaDocumentos1" runat="server" />
</asp:Content>
