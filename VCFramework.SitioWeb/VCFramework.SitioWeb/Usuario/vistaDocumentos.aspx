<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="vistaDocumentos.aspx.cs" Inherits="VCFramework.SitioWeb.Usuario.vistaDocumentos" %>
<%@ Register src="../controles/controlVistaDocumentos.ascx" tagname="controlVistaDocumentos" tagprefix="uc1" %>
...
@media only screen and (max-width: 500px) {
    ...
    <div class="row panel bg-titulo" style="margin:0.1em;">
        <span class="tituloContacto"><i class="foundicon-page padding-right-15"></i>Documentos de Asamblea</span>
    </div>
    <div class="row">
