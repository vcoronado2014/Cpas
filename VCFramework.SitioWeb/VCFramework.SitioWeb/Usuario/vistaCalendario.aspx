...
<%@ Register src="../controles/VerticalAppointment.ascx" tagname="VerticalAppointment" tagprefix="uc1" %>




<%@ Register src="../controles/HorizontalAppointment.ascx" tagname="HorizontalAppointment" tagprefix="uc2" %>
...
@media only screen and (max-width: 500px) {
    ...
    <div class="row padding10" style="margin:5px;">
        ...
        <%--<uc1:VerticalAppointment ID="VerticalAppointment1" runat="server" />--%>

        <dxwschs:ASPxScheduler ID="ASPxScheduler1" ClientInstanceName="ASPxScheduler1" runat="server" ActiveViewType="Month" AppointmentDataSourceID="odsCalendario" ClientIDMode="AutoID" Start="2015-12-13" Theme="Mulberry" Font-Size="12px" OnAppointmentFormShowing="ASPxScheduler1_AppointmentFormShowing" OnAppointmentViewInfoCustomizing="ASPxScheduler1_AppointmentViewInfoCustomizing">
            <Storage>
                <Appointments>
            ...
            <Views>
                <DayView>
                    ...
                    <TimeIndicatorDisplayOptions Visibility="Always"></TimeIndicatorDisplayOptions>
...
<TimeIndicatorDisplayOptions Visibility="Always"></TimeIndicatorDisplayOptions>
            ...
            <Templates>
                <HorizontalAppointmentTemplate>
                    <dx:ASPxLabel ID="ASPxLabel2" runat="server" Text='<%# ((DevExpress.Web.ASPxScheduler.HorizontalAppointmentTemplateContainer)Container).AppointmentViewInfo.Appointment.Subject %>'  ></dx:ASPxLabel>
                </HorizontalAppointmentTemplate>
                <HorizontalSameDayAppointmentTemplate>
                    <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text='<%# ((DevExpress.Web.ASPxScheduler.HorizontalAppointmentTemplateContainer)Container).AppointmentViewInfo.Appointment.Subject %>'  ></dx:ASPxLabel>
                </HorizontalSameDayAppointmentTemplate>
            </Templates>
            ...
            <%--            <Templates>
                ...
                <HorizontalAppointmentTemplate>
                    <uc2:HorizontalAppointment ID="HorizontalAppointment1" runat="server" />
                </HorizontalAppointmentTemplate>
            </Templates>--%>
