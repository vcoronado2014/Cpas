<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Listado.aspx.cs" Inherits="VCFramework.SitioWeb.Proyectos.Listado" %>
...
@media only screen and (max-width: 500px) {
    ...
    <script type="text/javascript">
        ...
        <span class="tituloContacto"><i class="foundicon-tools padding-right-15"></i>Proyectos</span>
    </div>
    <div class="row">
        <div class="medium-12 columns">

            <div class="panel">
                 <h4>¿Desea Agregar otro Proyecto?</h4>
        ...
        <div class="large-12 columns">
            ...
            <dx:ASPxGridView ID="grillaDocumentos" runat="server" AutoGenerateColumns="False" DataSourceID="ODSLISTADO" Width="100%" ClientInstanceName="grid" OnHtmlDataCellPrepared="grillaDocumentos_HtmlDataCellPrepared" Theme="Mulberry1">
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="FechaInicio" VisibleIndex="5" ShowInCustomizationForm="True" Width="15%" Caption="Fecha Inicio">
                    ...
                    <dx:GridViewDataTextColumn Caption=" " Name="control" VisibleIndex="0" Width="7%">
                        <DataItemTemplate>
                                <asp:HyperLink ID="hlInicio" runat="server" CssClass="item" NavigateUrl='<%# Eval("Id", "CrearProyecto.aspx?editar=true&eliminar=false&nuevo=false&id={0}")%>'>
                                        <span data-tooltip aria-haspopup="true" class="has-tip" title="Editar">
                                        <i class="foundicon-edit" ></i></span>
                                </asp:HyperLink>
                                <asp:HyperLink ID="HyperLink1" runat="server" CssClass="item" NavigateUrl='<%# Eval("Id", "CrearProyecto.aspx?eliminar=true&editar=false&nuevo=false&id={0}")%>' data-tooltip aria-haspopup="true" class="has-tip" title="Eliminar">
                                        <i class="foundicon-trash"></i>
                                </asp:HyperLink>

                            </DataItemTemplate>
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="Fecha" FieldName="FechaCreacion" VisibleIndex="2" Width="15%">
                        <Settings AllowAutoFilter="False" AllowHeaderFilter="False" ShowInFilterControl="False" />
                        <CellStyle Wrap="True">
                        </CellStyle>
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="Nombre" FieldName="Nombre" VisibleIndex="3" Width="38%">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="$" FieldName="Costo" VisibleIndex="4" Width="10%">
                        <Settings AllowAutoFilter="False" AllowHeaderFilter="False" />
                        <HeaderStyle HorizontalAlign="Center" />
                        <CellStyle HorizontalAlign="Center" VerticalAlign="Middle">
                        </CellStyle>
                    </dx:GridViewDataTextColumn>
<%--                    <dx:GridViewDataTextColumn VisibleIndex="7" Width="5%" Caption=" ">
                        <DataItemTemplate>
                            <i class='<%# Eval("Icon", "{0}")%>' ></i></span>
                        </DataItemTemplate>
                    </dx:GridViewDataTextColumn>--%>

                    <dx:GridViewDataTextColumn Caption="Fecha Ter." FieldName="FechaTermino" VisibleIndex="6" Width="15%">
                        <Settings AllowAutoFilter="False" AllowHeaderFilter="False" />
                    </dx:GridViewDataTextColumn>
            ...
            <asp:ObjectDataSource ID="ODSLISTADO" runat="server" SelectMethod="ObtenerProyectosPorInstIdTodos" TypeName="VCFramework.NegocioMySQL.Proyectos">
                <SelectParameters>
