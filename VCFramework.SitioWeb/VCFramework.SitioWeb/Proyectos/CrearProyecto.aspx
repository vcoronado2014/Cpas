<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="CrearProyecto.aspx.cs" Inherits="VCFramework.SitioWeb.Proyectos.CrearProyecto" %>
	...
	pnlGeneral.PerformCallback('eliminar|');
                ...
                <div class="panel" id="panelPrincipal">
                    ...
                    <div class="row">
                        <div class="name-field medium-6 columns">
                            <label>
                                1. Nombre del Proyecto <small>requerido</small>
                                <dx:ASPxTextBox ID="txtNombreProyecto" runat="server" Native="true" ClientInstanceName="txtNombreProyecto" Width="100%">
                                    <ValidationSettings ValidationGroup="panel">
                                        <RequiredField IsRequired="True" ErrorText="Nombre Proyecto Requerido" />
                                    </ValidationSettings>
                                </dx:ASPxTextBox>
                        ...
                        <div class="name-field medium-6 columns">
                            <label>
                                2. Objetivo del Proyecto <small>requerido</small> 
                                <dx:ASPxMemo ID="memObjetivo" runat="server" Height="70px" Width="100%" Native="true">
                                    <ValidationSettings ValidationGroup="panel">
                                        <RequiredField IsRequired="True" ErrorText="Objetivo Proyecto Requerido" />
                                    </ValidationSettings>
                                </dx:ASPxMemo>
                    ...
                    <div class="row">
                        <div class="name-field medium-6 columns">
                        <label>
                            3. Descripción del Proyecto <small>requerido</small>
                            <dx:ASPxMemo ID="memDescripcion" runat="server" Height="70px" Width="100%" Native="true">
                                <ValidationSettings ValidationGroup="panel">
                                    <RequiredField IsRequired="True" ErrorText="Descripción Proyecto Requerido" />
                                </ValidationSettings>
                            </dx:ASPxMemo>
                        ...
                        <div class="name-field medium-6 columns">
                        <label>
                            4. Beneficios del Proyecto <small>requerido</small>
                            <dx:ASPxMemo ID="memBeneficios" runat="server" Height="70px" Width="100%" Native="true">
                                <ValidationSettings ValidationGroup="panel">
                                    <RequiredField IsRequired="True" ErrorText="Beneficios Proyecto Requerido" />
                                </ValidationSettings>
                            </dx:ASPxMemo>
                    ...
                    <div class="row">
                        <div class="name-field medium-3 columns">
                            <label>
                                ...
                                <dx:ASPxTextBox ID="txtCosto" runat="server" Native="true" ClientInstanceName="txtCosto" Width="100%">
                                    <ValidationSettings ValidationGroup="panel">
                                        <RegularExpression ErrorText="Sólo números" ValidationExpression="^\d+$" />
                                        <RequiredField IsRequired="True" ErrorText="Costo Proyecto Requerido" />
                                    </ValidationSettings>
                                </dx:ASPxTextBox>
                            </label>
                    ...
                    <div class="row">
                        ...
                        <div class="name-field medium-3 columns">
                            <dx:ASPxCheckBox ID="chkEnviaCorreo" runat="server" Text="Envía correo a los participantes." BackColor="Transparent" Border-BorderColor="Transparent">
<Border BorderColor="Transparent"></Border>
                            </dx:ASPxCheckBox>
                            
                        </div>
                        <div class="name-field medium-3 columns">
                            <dx:ASPxCheckBox ID="chkNotificaPopup" runat="server" Text="Notifica mediante popup a los participantes." BackColor="Transparent" Border-BorderColor="Transparent">
<Border BorderColor="Transparent"></Border>
                            </dx:ASPxCheckBox>
                    ...
                    <div class ="row">
                        ...
                        <div class="name-field medium-6 columns">
                            ...
                            <asp:ObjectDataSource ID="ODSLISTADO" runat="server" SelectMethod="ObtenerArchivosPorProyectoId" TypeName="VCFramework.NegocioMySQL.ArchivosProyecto">
                                <SelectParameters>
                                    <asp:QueryStringParameter DefaultValue="0" Name="proId" QueryStringField="id" Type="Int32" />
